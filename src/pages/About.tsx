                ...
                <section className="mb-12">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
                            ...
                            <p className="text-slate-700 dark:text-slate-300 mb-2">An intelligent Spotify management assistant that automates playlist creation, music discovery, and library organization. Users can interact with an AI agent that creates custom playlists based on natural language descriptions, suggests personalized music recommendations, discovers new tracks aligned with their taste, and cleans up duplicate songs across playlists—all while maintaining full visibility and control over every action the agent performs.</p>
                            <ul className="list-disc list-inside text-slate-700 dark:text-slate-300 space-y-1">
