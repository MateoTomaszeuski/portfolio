  ...
  const projects = [
    {
      ...
      deployed: null,
      github:
        "https://github.com/MateoTomaszeuski/2d-battle-royale-distributed-app",
      items: [
    ...
    },
    {
      ...
      description:
        "A comprehensive trip planning application built in a four-developer AGILE/SCRUM team. Full-stack development with C# backend, React frontend, and PostgreSQL database. Deployed using Docker locally, Kubernetes for testing, and Azure for production.",
    ...
    },
    {
      ...
      description:
        "A student planning application developed using .NET MAUI with ASP.NET CORE API and PostgreSQL database. Led multiple rounds of structured user testing to evaluate usability. Worked integrally with a dynamic, four-developer team in an agile environment.",
      deployed: "https://consilium.mateo.tomaszeuski.com/",
      github:
        "https://github.com/MateoTomaszeuski/consilium-student-planner-app",
      items: [
    ...
    },
    {
      ...
      timeline: "Jan 2024",
      description:
        "A health and fitness calculator developed using Visual Studio with Blazor Web App for the UI. Presents calculations running in C# and includes a Persistence Class that saves user information to the database.",
      deployed: null,
      github: null,
      items: [
      ...
      <div className="container mx-auto px-4 py-6 md:py-8 max-w-6xl">
        ...
        <Section title="About">
          <div className="space-y-4 text-slate-700 dark:text-slate-300 leading-relaxed">
            <p>
              I'm a software engineer who focuses on strategic communications,
              client relationships, and the integration of technology and AI. I
              bring a strong technical foundation in full-stack web development,
              data analysis, and cloud services.
            </p>
            <p>
              My background spans software engineering with expertise in React,
              ASP.NET Core, Elixir, Docker, Kubernetes, and cloud services, as
              well as database management with PostgreSQL, data science, and
              CI/CD pipeline implementation. I combine technical depth with
              strong organizational and communication skills, making me
              effective at bridging the gap between engineering expertise and
              client-facing initiatives.
            </p>
            <p>
              I'm passionate about building modern web applications,
              implementing AI solutions, and continuously improving software
              systems. My work involves designing and developing websites,
              upgrading technologies, working in Agile/Scrum environments, and
              ensuring technical solutions are clearly communicated to
              stakeholders.
            </p>
          </div>
        </Section>
            ...
            <div className="space-y-4">
              <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-sm">
                <h3 className="font-semibold text-slate-900 dark:text-white">
                  Bachelor's Degree - Software Engineering - Web Development &
                  Data Science
                </h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  (Snow College, 2024 - 2026)
                </p>
              </div>
              <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-sm">
                <h3 className="font-semibold text-slate-900 dark:text-white">
                  Associate's in Science Degree - Computer Science
                </h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  (Snow College, 2022 - 2024)
                </p>
              </div>
            </div>
          </Section>
