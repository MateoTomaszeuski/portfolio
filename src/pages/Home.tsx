  ...
  return <main id="main">
    <section className="shell hero" aria-labelledby="hero-title">
      <div className="hero-copy">
        ...
        <div className="hero-actions"><a className="button button-primary" href="#work">Explore my work <span aria-hidden="true"><Icon name="arrow-up-right" /></span></a><a className="text-link" href="/resume.pdf" download="Mateo Tomaszeuski - Resume.pdf">Download résumé <span aria-hidden="true"><Icon name="arrow-down" /></span></a></div>
        <div className="hero-footnote"><span className="tiny-cross" aria-hidden="true"><Icon name="plus" /></span><span>C# / .NET &nbsp;·&nbsp; Angular & React &nbsp;·&nbsp; Applied AI</span></div>
      </div>
      <figure className="portrait-frame">
        <div className="portrait-topline"><span>THE PERSON BEHIND THE CODE</span><span aria-hidden="true"><Icon name="arrow-up-right" /></span></div>
    ...
    <div className="shell current-role"><span className="eyebrow"><span className="status-dot" /> CURRENTLY</span><div><strong>Programmer/Analyst</strong><span>at DHI Computing Service, Inc.</span></div><p>Building banking applications<br />with C#/.NET & Angular</p><a href="#experience" aria-label="Explore my experience"><Icon name="arrow-up-right" /></a></div>
    <Work />
    <Experience />
    <About />
    <Contact />
